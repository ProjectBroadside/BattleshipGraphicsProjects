...
const toolDescription = "Retrieves complete hierarchy of all GameObjects in Unity loaded scenes with their active state and full details";
const paramsSchema = z.object({
  // No parameters needed for this tool - it fetches all hierarchy data
});

/**
 * Creates and registers the Get Scenes Hierarchy tool with the MCP server
 * This tool allows retrieving complete scene hierarchy data as a tool rather than resource
 *
...
/**
 * Handles requests for Unity complete scene hierarchy
 *
 * @param mcpUnity The McpUnity instance to communicate with Unity
